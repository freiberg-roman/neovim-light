...
local function resolve_config(server_name, ...)
  local defaults = {
    on_attach = require("light.lsp").common_on_attach,
    on_init = require("light.lsp").common_on_init,
    on_exit = require("light.lsp").common_on_exit,
    capabilities = require("light.lsp").common_capabilities(),
  }
...
function M.setup(server_name, user_config)
  ...
  if light_lsp_utils.is_client_active(server_name) or client_is_configured(server_name) then
    return
  end
  ...
  local should_auto_install = function(name)
    local installer_settings = light.lsp.installer.setup
