...
function M.get_prefix()
  ...
  return vim.tbl_get(light.builtin, "mason", "install_root_dir") or default_prefix
end
...
function M.setup()
  ...
  add_to_path(light.builtin.mason.PATH == "append")

  mason.setup(light.builtin.mason)

  if light.builtin.mason.on_config_done then
    light.builtin.mason.on_config_done(mason)
  end
end
