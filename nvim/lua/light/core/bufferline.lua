...
M.setup = function()
  require("light.keymappings").load(bufferline_config.keymap)
  ...
  bufferline.setup {
    options = bufferline_config.options,
    highlights = bufferline_config.highlights,
  }

  if bufferline_config.on_config_done then
    bufferline_config.on_config_done()
  end
end
