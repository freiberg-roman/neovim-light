...
M.config = function()
  light.builtin.bufferline = {
    ...
    options = {
      ...
      show_buffer_icons = light.use_icons, -- disable filetype icons for buffers
      show_buffer_close_icons = light.use_icons,
...
M.setup = function()
  require("light.keymappings").load(light.builtin.bufferline.keymap)
  ...
  bufferline.setup {
    options = light.builtin.bufferline.options,
    highlights = light.builtin.bufferline.highlights,
  }

  if light.builtin.bufferline.on_config_done then
    light.builtin.bufferline.on_config_done()
  end
end
