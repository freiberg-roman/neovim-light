    ...
    { -- taken from AstroNvim
      "BufEnter",
      {
        ...
        callback = function(args)
          ...
          if require("light.utils").is_directory(bufname) then
...
function M.enable_format_on_save()
  ...
  vim.api.nvim_create_autocmd("BufWritePre", {
    ...
    callback = function()
      require("light.lsp.utils").format { timeout_ms = opts.timeout, filter = opts.filter }
    end,
  })
end
...
function M.enable_reload_config_on_save()
  ...
  vim.api.nvim_create_augroup("light_reload_config_on_save", {})
  vim.api.nvim_create_autocmd("BufWritePost", {
    group = "light_reload_config_on_save",
    pattern = pattern,
    desc = "Trigger lightReload on saving config.lua",
    callback = function()
      require("light.config"):reload()
    end,
  })
end
