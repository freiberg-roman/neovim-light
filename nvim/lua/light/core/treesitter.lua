...
function M.setup()
  ...
  local opts = vim.deepcopy(light.builtin.treesitter)

  treesitter_configs.setup(opts)

  if light.builtin.treesitter.on_config_done then
    light.builtin.treesitter.on_config_done(treesitter_configs)
  end
